...
-- Fallback to enUS for missing translations
if L ~= (BeastAndBow_locales["enUS"] or {}) then
    local en = BeastAndBow_locales["enUS"] or {}
    setmetatable(BeastAndBow.L, { __index = en })
end
